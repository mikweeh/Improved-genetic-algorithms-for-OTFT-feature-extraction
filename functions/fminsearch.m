...
% usual_delta = 0.0005;             % 5 percent deltas for non-zero terms
% zero_term_delta = 0.0000025;      % Even smaller delta for zero elements of x
for j = 1:n
    y = xin;
    if y(j) ~= 0
...
if func_evals >= maxfun
    ...
    msg = sprintf(['Se ha superado el número máximo de evaluaciones de la función.\n' ...
                   'Mejore el resultado incrementando este parámetro.\n' ...
                   'Valor actual de la función: %1.3e \n'], fval);
    if prnt > 0
        disp(' ')
        disp(msg)
    end
...
elseif itercount >= maxiter
    ...
    %               '         Current function value: %f \n'], fval);
    msg = sprintf(['Se ha superado el número máximo de iteraciones.\n' ... 
                   'Mejore el resultado incrementando este parámetro.\n' ...
                   'Valor actual de la función: %1.3e \n'], fval);
               if prnt > 0
        disp(' ')
...
%                tolx, tolf);
    msg = ...
      sprintf(['Optimización finalizada:\n', ...
               ' La solución aportada satisface los criterios de tolerancia de la solución:  %1.1e \n' ...
               ' y de tolerancia de la función de error: %1.1e \n'], ...
               tolx, tolf);
    if prnt > 1
        disp(' ')
        disp(msg)
